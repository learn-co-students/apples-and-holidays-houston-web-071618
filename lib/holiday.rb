...
holiday_hash[:winter].each do|day, sup| sup << supply
  end
end
...
winter_supplies = holiday_hash[:winter].collect do |k, v|
  v
end
...
def all_supplies_in_holidays(holiday_hash)
  ...
  # etc.
   holiday_supplies.each do |season, holidays| seasons = season.to_s
